...
public class LoadingScreen implements Screen {
    ...
    private final SastaTankStars app;

    private ShapeRenderer shapeRenderer;
    private float progress;

    public LoadingScreen(final SastaTankStars app) {
        this.app = app;
    ...
    private void queueAssets() {
        ...
        app.assets.load("menuscreen.png", Texture.class);
    ...
    public void render(float delta) {
        ...
        shapeRenderer.rect(32, app.camera.viewportHeight / 2 - 8, app.camera.viewportWidth - 64, 32);

        shapeRenderer.setColor(Color.BLUE);
        shapeRenderer.rect(32, app.camera.viewportHeight / 2 - 8, progress * (app.camera.viewportWidth - 64), 32);
        shapeRenderer.end();
    }
    @Override
